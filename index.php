...
//jika "corpus"
if ($apa == "corpus") {
	$result = $con->query("SELECT * FROM tbberita ORDER BY Id");
...
//jika "indexing"
	...
	$result = $con->query("SELECT * FROM tbvektor");
...
//jika "showindex"
	...
	$result = $con->query("SELECT * FROM tbindex ORDER BY Id");
...
//jika "cache"
	...
	$result = $con->query("SELECT * FROM tbcache ORDER BY Query ASC");
